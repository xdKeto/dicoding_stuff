...
//   return products.filter((i) => i.category == "Electronics");
// }
...
//   return products.reduce((i, j) => j.price + i, 0);
// }
...
//   return products.map((product) => ({ ...product, price: product.price - (discount/100 * product.price) }));
// }
